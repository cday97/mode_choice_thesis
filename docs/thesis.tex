...
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{llll>{\raggedright\arraybackslash}p{12em}}
\toprule
Scenario Number & Scenario Name & ActivitySim Input Type & BEAM Utility Variables & Scenario Description\\
\midrule
1 & None & With RH & Path, Person, Location & Mode Choice Off\\
2 & All-ALL-wRH & With RH & Path, Person, Location & All variables used\\
3 & All-All-wRH & With Ride Hail & Path & just path variables used just path variables used just path variables used just path variables used just path variables used\\
\bottomrule
\end{tabular}}
\end{table}
