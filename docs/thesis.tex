...
\hypertarget{mscen}{%
\section{Creating the Scenario}\label{mscen}}
...
{\centering \includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/figregion-1} 

}

\caption{The TAZs of the region of study.}\label{fig:figregion}
\end{figure}
...
\item
  The project researches live in this region, and therefore have real life knowledge of how transportation works in the region. This allows the researchers to compare the the results of the models with their own experiences, hopefully providing extra verification.
\end{enumerate}

Specifically, the the region used to create the population of agents

\hypertarget{activitysim-setup}{%
\subsection{ActivitySim Setup}\label{activitysim-setup}}

\hypertarget{beam-setup}{%
\subsection{BEAM Setup}\label{beam-setup}}
