...
#piechart <- tar_read(piechart)
#piechart
#ggsave("piechart.png",width = 6,height= 4.3)
...
\begin{figure}
\hspace*{-1.6in}
\includegraphics[width = .75\paperwidth]{piechart.png}
\caption[Original mode choices of agents who were assigned to ride-hail.]{Original mode choices of agents who were assigned to a ride-hail type mode.}
\label{fig:piechart}
\end{figure}
