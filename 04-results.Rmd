...
kbl(ridership, caption = 'Ride-hail Ridership by Number of Total Trips by Mode Choice Combination.', booktabs = TRUE, linesep = c("\\addlinespace",rep("",9)), format="latex") %>%
