...
The specific values for the coefficients used in the csv input file were taken from @mtc12. [*explain if tour or trip values and if you multiplied by 2?*] Below, a list of the path, person, and location variables used to calculate the modal utility is shown.
