...
```{r fig-asim-nest, fig.cap = "Nested logit model used in ActivitySim.", fig.asp=1, fig.align='center', out.extra = 'trim = {3cm 6.5cm 4.5cm 6cm}', out.width="1.8\\linewidth", wrapfigure = list("R", .5),  echo=FALSE}
#
