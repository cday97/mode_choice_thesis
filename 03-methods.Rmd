...
```{r hbw, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Home-based work mode choice path coefficients model comparison.", fig.align='center', out.width = "400px"}
tar_read(hbw_graph)
```
...
```{r hbs, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Home-based school mode choice path coefficients model comparison.", fig.align='center', out.width = "400px"}
tar_read(hbs_graph)
```
...
```{r hbo, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Home-based other mode choice path coefficients model comparison.", fig.align='center', out.width = "400px"}
tar_read(hbo_graph)
```
